...
MirrorMode::MirrorMode(bool** board, unsigned short row, unsigned short col)
{
...
int MirrorMode::simulateEachStep()
{
    std::cout << std::endl;
    std::cout << "------------ Mirror Mode ------------" << std::endl;
...
unsigned short MirrorMode::getNeighbors(unsigned short currRow, unsigned short currCol)
{
...
unsigned short MirrorMode::getNeighborsFromCorner(unsigned short currRow, unsigned short currCol)
{
    ...
    {
        if (currBoard[currRow][currCol] == 1)
            neighbors += 3; // mirror reflects vertical, horizontal, and diagnal
        if (currBoard[currRow][currCol+1] == 1)
            neighbors += 2; // mirror reflects the right twice
        if (currBoard[currRow+1][currCol+1] == 1)
            neighbors++;
        if (currBoard[currRow+1][currCol] == 1)
            neighbors += 2; // mirror reflects the bottom twice
    }
...
unsigned short MirrorMode::getNeighborsFromEdge(unsigned short currRow, unsigned short currCol)
{
    unsigned short neighbors = 0;
...
unsigned short MirrorMode::getNeighborsFromOtherCells(unsigned short currRow, unsigned short currCol)
{
    unsigned short neighbors = 0;
