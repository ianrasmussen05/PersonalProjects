...
ClassicMode::ClassicMode(bool** board, unsigned short row, unsigned short col)
{
...
int ClassicMode::simulateEachStep()
{
    std::cout << std::endl;
...
unsigned short ClassicMode::getNeighbors(unsigned short currRow, unsigned short currCol)
{
...
unsigned short ClassicMode::getNeighborsFromCorner(unsigned short currRow, unsigned short currCol)
{
    unsigned short neighbors = 0;

    // check if the current cel is on the corners
...
unsigned short ClassicMode::getNeighborsFromEdge(unsigned short currRow, unsigned short currCol)
{
    unsigned short neighbors = 0;
...
unsigned short ClassicMode::getNeighborsFromOtherCells(unsigned short currRow, unsigned short currCol)
{
    unsigned short neighbors = 0;
